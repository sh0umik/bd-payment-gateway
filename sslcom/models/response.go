...
// A FlexFloat64 is an int that can be unmarshalled from a JSON field
...
func (fi *FlexFloat64) UnmarshalJSON(b []byte) error {
	if b[0] != '"' {
...
type OrderValidationResponse struct {
	...
	DiscountAmount             FlexFloat64 `json:"discount_amount"`
